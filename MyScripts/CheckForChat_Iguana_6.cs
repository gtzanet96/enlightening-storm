...
public class CheckForChat_Iguana_6 : MonoBehaviour
{
    public static bool entrance_phone = false; //να ενεργοποιειται οταν ο παικτης ειναι μεσα στο range του NPC
