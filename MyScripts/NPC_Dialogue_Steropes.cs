...
public class NPC_Dialogue_Steropes : MonoBehaviour
{
    ...
    //same for negative, for more details see gregor
    ...
    void Update()
    {
        if (CheckForChat_Steropes.entrance_steropes == true)
        {
            if (Umbrella_Mission.brontes_over == true && Umbrella_Mission.steropes_over == false && Input.GetKeyDown("f"))
            {
    ...
    void loadDialogue1BotBotTopSubTree()
    {
        ...
        Umbrella_Mission.steropes_over = true;
        Umbrella_Mission.arges_start = true;
    }
    ...
    public void Top()
    {
        ...
        else if (inDialogueBotTopSubTree)
        {
            ...
            {
                Score_Script.score = Score_Script.score + 1;
                points_1.text = "Score:" + (Score_Script.score).ToString();
                points_2.text = "Score:" + (Score_Script.score).ToString();
                correct_sound.Play();
