...
public class NPC_Dialogue_Iguana_2 : MonoBehaviour
{
    ...
    public static bool iguana_2_spoke = false;
    ...
    private bool positive_2_counted = false;
    ...
    public void Bot()
    {
        ...
        {
            //score
            if (talked_once == false && positive_2_counted == false)
            {
                Score_Script.score = Score_Script.score + 200;
                points_1.text = "Score:" + (Score_Script.score).ToString();
                points_2.text = "Score:" + (Score_Script.score).ToString();
                correct_sound.Play();
                positive_2_counted = true;
            }
        }
        else if (inDialogueBotTopSubTree)
        {
