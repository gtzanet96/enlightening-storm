...
public class NPC_Dialogue_Brontes : MonoBehaviour
{
    ...
    //same for negative, see gregor for more details
    ...
    void Update()
    {
        if (CheckForChat_Brontes.entrance_brontes == true)
        {
            if (Umbrella_Mission.brontes_over == false && Input.GetKeyDown("f"))
            {
    ...
    void loadDialogue1BotBotTopSubTree()
    {
        ...
        Umbrella_Mission.brontes_over = true;
        Umbrella_Mission.steropes_start = true;
    }
