...
public class NPC_Dialogue_Iguana_3 : MonoBehaviour
{
    ...
    public static bool iguana_3_spoke = false;
    ...
    void Start()
    {
        iguana_3_spoke = false;
    }

    void Update()
    {
        if (CheckForChat_Iguana_3.entrance_tall_tree == true)
        {   
            //the first time the player enters the collider, the dialogue will be displayed automatically
            if (iguana_3_spoke == false)
            {
