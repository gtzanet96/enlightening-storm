...
public class NPC_Dialogue_Iguana_8 : MonoBehaviour
{
    ...
    public static bool iguana_8_spoke = false;
    ...
    public void Bot()
    {
        if (inDialogue1)
        {
            ...
            if (talked_once == false)
            {
                Score_Script.score = Score_Script.score + 99;
                points_1.text = "Score:" + (Score_Script.score).ToString();
                points_2.text = "Score:" + (Score_Script.score).ToString();
                false_sound.Play();
            }
